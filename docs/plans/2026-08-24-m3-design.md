...
- [x] **Step 1: Write the failing path-helper test**
...
- [x] **Step 3: Add the helpers to `scripts/lib/paths.mjs`**
...
- [x] **Step 5: Write the failing schema-v3 test**
...
- [x] **Step 7: Implement in `scripts/lib/schema.mjs`**
...
- [x] **Step 9: Write the failing migration test**
...
- [x] **Step 11: Add the v2→v3 branch in `scripts/lib/state.mjs`**
...
- [x] **Step 1: Create the golden fixture**
...
- [x] **Step 3: Run and watch every test fail**

Run: `node --test tests/lib/stack-schema.test.mjs`
Expected: FAIL — module not found.

- [x] **Step 4: Implement `scripts/lib/stack-schema.mjs`**
...
- [x] **Step 5: Run and watch every test pass**
...
- [x] **Step 2: Prove the prose tests can fail**
...
- [x] **Step 4: Implement `scripts/lib/stack-apply.mjs`**
...
- [x] **Step 3: Implement `scripts/stack.mjs`**
...
- [x] **Step 5: Write `commands/stack.md`**
...
- [x] **Step 7: Prove those prose tests can fail**
...
- [x] **Step 1: Create `tests/fixtures/h0-architecture.json`**
...
- [x] **Step 4: Implement `scripts/lib/architecture-schema.mjs`**
...
- [x] **Step 3: Implement `scripts/lib/layout.mjs`**
...
- [x] **Step 3: Implement `scripts/lib/emit-mermaid.mjs`**
...
- [x] **Step 4: Run and fix the arrow line**
...
- [x] **Step 3: Implement `scripts/lib/emit-svg.mjs`**
...
- [x] **Step 3: Implement `scripts/lib/emit-drawio.mjs`**
...
- [x] **Step 5: Verify the output actually opens**
...
- [x] **Step 2: Prove one prose test can fail**
...
- [x] **Step 4: Implement `scripts/lib/render-architecture.mjs`**
...
- [x] **Step 3: Implement `scripts/lib/render-data-model.mjs`**
...
- [x] **Step 1: Extend the marker tests**
...
- [x] **Step 3: Parameterise `scripts/lib/markers.mjs`**
...
- [x] **Step 5: Write the failing `render-agents` tests**
...
- [x] **Step 7: Implement `scripts/lib/render-agents.mjs`**
...
- [x] **Step 8: Run and reconcile the ordering test**
...
- [x] **Step 3: Implement `scripts/lib/architect-apply.mjs`**
...
- [x] **Step 5: Write `scripts/architect.mjs`**
...
- [x] **Step 7: Write `agents/solution-architect.md`**
...
- [x] **Step 8: Write `commands/architect.md`**
...
- [x] **Step 9: Add command and agent tests**
...
- [x] **Step 10: Prove two of those prose tests can fail**
...
- [x] **Step 1: Write `skills/security-invariants/references/invariants-corpus.md`**
...
- [x] **Step 2: Write `skills/framework-drift-guard/SKILL.md`**
...
- [x] **Step 3: Write `skills/security-invariants/SKILL.md`**
...
- [x] **Step 4: Write the falsifiable skill tests**
...
- [x] **Step 5: Prove three of these can fail**
...
- [x] **Step 1: Measure both shapes before writing**
...
- [x] **Step 2: Write `skills/monorepo-structure/SKILL.md`**
...
- [x] **Step 3: Write `skills/architecture-diagramming/SKILL.md`**
...
- [x] **Step 4: Write the falsifiable tests**
...
- [x] **Step 5: Prove two can fail, run, commit**
...
- [x] **Step 1: Read the four evidence sources**
...
- [x] **Step 2: Write `skills/frontend-architecture/SKILL.md`**
...
- [x] **Step 3: Write `skills/backend-architecture/SKILL.md`**
...
- [x] **Step 4: Write `skills/data-modeling/SKILL.md`**
...
- [x] **Step 5: Write `skills/ui-design-principles/SKILL.md`**
...
- [x] **Step 6: Write the falsifiable tests**
...
- [x] **Step 7: Prove two can fail, run, commit**
...
- [x] **Step 1: Write the failing status-board test**
...
- [x] **Step 2: Implement the two board sections**
...
- [x] **Step 3: Extract the shared table helper**
...
- [x] **Step 4: Extend the manifest test**
...
- [x] **Step 5: Write the end-to-end Stage 1 test**
...
- [x] **Step 7: Commit and open the review checkpoint**
...
- [x] **Step 1: Create `tests/fixtures/h0-requirements.json`**
...
- [x] **Step 4: Implement `scripts/lib/requirements-schema.mjs`**
...
- [x] **Step 3: Implement `scripts/lib/emit-gherkin.mjs`**
...
- [x] **Step 4: Implement `scripts/lib/render-requirements.mjs`**
...
- [x] **Step 6: Prove one prose test can fail**
...
- [x] **Step 3: Implement `scripts/lib/requirements-apply.mjs`**
...
- [x] **Step 4: Write `scripts/requirements.mjs`**
...
- [x] **Step 5: Write `commands/requirements.md`**
...
- [x] **Step 6: Add CLI and command tests**
...
- [x] **Step 7: Run everything, prove one prose test can fail, commit**
...
- [x] **Step 3: Implement `scripts/lib/emit-kiro.mjs`**
...
- [x] **Step 3: Implement `scripts/lib/openspec.mjs`**
...
- [x] **Step 3: Implement `scripts/lib/spec-apply.mjs`**
...
- [x] **Step 4: Write `scripts/spec.mjs`**
...
- [x] **Step 5: Write `commands/spec.md`**
...
- [x] **Step 7: Prove one prose test can fail, run, commit**
...
- [x] **Step 1: Write `skills/gherkin-requirements/SKILL.md`**
...
- [x] **Step 2: Write `skills/openspec-workflow/SKILL.md`**
...
- [x] **Step 3: Write the falsifiable tests**
...
- [x] **Step 4: Prove two can fail, run, commit**
...
- [x] **Step 1: Extend the manifest test to the full M3 surface**
...
- [x] **Step 2: Write the end-to-end Stage 2 test**
...
- [x] **Step 3: Amend `docs/design/win-hackathon-plugin.md`**
...
- [x] **Step 5: Run the full suite on all three Node versions CI uses**
...
- [x] **Step 6: Walk the M3 milestone check by hand**

From spec §12. Confirm each and record the result in the task report:

- [x] From a clean scratch project with an approved `:describe`, all four phases run to four approved gates
- [x] All three diagram formats render, and every component appears in each
- [x] `AGENTS.md` carries the drift block and the numbered invariants, and `CLAUDE.md` is `@AGENTS.md`
- [x] A rubric criterion with no feature fails validation
- [x] The OpenSpec-unreachable path still produces three surfaces
- [ ] `/tmp/arch-check.drawio` from Task 9 opens correctly at app.diagrams.net *(human check)* — not yet performed
...
Both stages complete. `npm test` → **710 tests, 0 failures, 0 skipped**, green on Node 20, 22
and 24. The five mechanical milestone checks above are each covered by a passing integration
or unit test, re-run individually to confirm:

- **Four phases, four approved gates, no drift** — `integration-stage1.test.mjs` ("stack then
  architect, from a clean project, ends approved with no drift") and
  `integration-stage2.test.mjs` ("with all four phases approved, `:next` resolves cleanly to
  `:build` with no drift").
- **All three diagram formats render, every component in each** — `integration-stage1.test.mjs`
  ("all ten `:architect` artifacts land on disk", "the three diagram renderings agree on every
  component").
- **`AGENTS.md` drift block, numbered invariants, `CLAUDE.md` as `@AGENTS.md`** —
  `tests/lib/render-agents.test.mjs`, whole file.
- **A rubric criterion with no feature fails validation** —
  `integration-stage2.test.mjs` ("a criterion with no feature stops the pipeline at
  `:requirements`").
- **OpenSpec-unreachable path still produces three surfaces** —
  `integration-stage2.test.mjs` ("an unreachable OpenSpec leaves the other three surfaces
  complete").

Merged fast-forward into `main` and pushed to origin. The final whole-branch review (solo,
opus, no fan-out) found six Important findings, no Critical, closed in one fix wave plus one
scoped re-review — detailed in `win-hackathon-plugin-project.md` memory, not restated here.

**Two boxes stay open on purpose, exactly as M2 left two open:** the drawio human check
(`/tmp/arch-check.drawio` opening correctly at app.diagrams.net) has not been performed, and a
live run against a real Devpost hackathon remains outstanding. Neither is a mechanical
assertion; both are human judgment calls.

**One known follow-up, out of scope for this plan:** `scripts/lib/init-apply.mjs` still uses
the collision-prone single-stamp `backupFile()` that the Stage 2 review replaced everywhere
else in this plan's scope (`:stack`/`:architect`/`:requirements`/`:spec` all now use
`openBackupSet`). Two `:init` applies within one wall-clock second can still silently destroy
a user's file. Mechanical fix, not done here because `:init` was not in this branch's diff.
